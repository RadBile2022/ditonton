...
final TextStyle kHeading6 = TextStyle(fontFamily: "Poppins",
    fontSize: 19, fontWeight: FontWeight.w500, letterSpacing: 0.15);
final TextStyle kSubtitle = TextStyle(fontFamily: "Poppins",
    fontSize: 15, fontWeight: FontWeight.w400, letterSpacing: 0.15);
final TextStyle kBodyText = TextStyle(fontFamily: "Poppins",
